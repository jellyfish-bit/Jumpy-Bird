...
const savedBestProgress = localStorage.getItem('bestProgressL' + levelNumber);
if(savedBestProgress != null) {
  bestScore = savedBestProgress;
}
...
function saveBestScore() {
  localStorage.setItem('bestProgressL' + levelNumber, bestScore);
}
function saveLevelComplete() {
  localStorage.setItem('levelComplete' + levelNumber, true)
}
